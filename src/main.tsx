  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      <div className="content">
        ...
        {row?.provenance.project&&<div className="search-summary project-actions" role="status"><span>{row.provenance.project.name} · {row.provenance.project.directory}</span><button onClick={()=>void action('project',row)}>Open folder</button><button onClick={()=>void action('copy',row,'projectPath')}>Copy path</button></div>}
