import './native';
import { clearSearch, resetFilters, hasFilters, identity, inspectLabel, sortListeners, openTarget, stopFeedback } from './explorer';
...
function App(){
  ...
  async function refresh(){
    ...
    try{const snapshot=await window.portwhim.scan();setData(snapshot);setError('');return snapshot;}catch(e){setError(String(e));}finally{inFlight.current=false;setBusy(false);}
  }
