import './native';
import { clearSearch, resetFilters, hasFilters, identity, inspectLabel, sortListeners, openTarget, stopFeedback, matchesQuery, queryPort } from './explorer';
  ...
  return <div className="app-shell">
    ...
    <main>
      ...
      <div className="content">
        ...
        <Favorites data={data} onSelect={(port,protocol)=>{setQuery(`:${port}`);setProtocol(protocol);setFilter('all');search.current?.focus();}} onChange={()=>{}}/>
