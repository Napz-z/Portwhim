...
- **Interaction:** spring-driven shared selection indicators, continuous list repositioning, view transitions and panel entrance/exit. Favorites and session activity open from a compact toolbar; forms appear only when requested. Dialogs contain and restore keyboard focus. About & shortcuts includes Follow system / Full motion / Reduced motion preferences.
